      ...
      <div class="container">
        <div class="row">
            ...
            <div class="box box-solid">
              ...
              <div class="box-body no-padding">
                ...
                <li class="active"><a href="edit-profile.php"><i class="fa fa-user"></i> Edit Profile</a></li>
                  ...
                  <li><a href="form.php"><i class="fa fa-list-ul"></i> Application Forms</a></li>
          ...
          <div class="col-md-9 bg-white padding-2">
            ...
            <p>Below you will find all your application </p>

            <?php
             $sql = "SELECT * FROM stipend_applications  WHERE stipend_applications.id_student='$_SESSION[id_student]'";
            ...
            <div class="attachment-block clearfix padding-2">
                <h4 class="attachment-heading"><?php echo "Stipend Application"; ?></h4>
                <div class="attachment-text padding-2">
                  <div class="pull-left"><i class="fa fa-calendar"></i> <?php echo $row['applieddate']; ?></div>  
                  <?php 
