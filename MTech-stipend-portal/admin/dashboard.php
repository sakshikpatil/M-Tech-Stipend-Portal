...
<head>
  ...
  <title>Stipend Management Portal</title>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-9 bg-white padding-2">
            ...
            <h3>Stipend Management Portal Statistics</h3>
            <div class="row">
              <div class="col-md-6">
                <div class="info-box bg-c-yellow">
                  <span class="info-box-icon bg-red"><i class="ion ion-briefcase"></i></span>
                  <div class="info-box-content">
                    <span class="info-box-text">Approved Stipend Applications</span>
                    <?php
                    $sql = "SELECT * from stipend_applications WHERE status = '1'";
              ...
              <div class="col-md-6">
                <div class="info-box bg-c-yellow">
                  <span class="info-box-icon bg-green"><i class="ion ion-person-stalker"></i></span>
                  <div class="info-box-content">
                    <span class="info-box-text">Pending Stipend Application Confirmation</span>
                    <?php
                    $sql = "SELECT * from stipend_applications WHERE status = '0' ";
                    $result = $conn->query($sql);
                    if($result->num_rows > 0) {
                      $totalno = $result->num_rows;
                    } else {
              ...
              <div class="col-md-6">
                <div class="info-box bg-c-yellow">
                  ...
                  <div class="info-box-content">
                    <span class="info-box-text">Total Stipend Applications</span>
                    <?php
                    $sql = "SELECT * from stipend_applications ";
                    $result = $conn->query($sql);
                    if($result->num_rows > 0) {
                      $totalno = $result->num_rows;
                    } else {
